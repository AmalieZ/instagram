...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            <li><span class="icon"></span>Domů</li>
            <li><span class="icon"></span>Hledat</li>
            <li><span class="icon"></span>Objevujte</li>
            <li><span class="icon"></span>Reels</li>
            <li><span class="icon"></span>Zprávy</li>
            <li><span class="icon"></span>Upozornění</li>
            <li><span class="icon"></span>Vytvořit</li>
            <li><span class="icon"></span>Profil</li>
        </ul>
    </div>
